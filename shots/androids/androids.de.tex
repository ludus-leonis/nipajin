...
\renewcommand{\androidsVersion}{v1.1.1}
...
\renewcommand{\androidsText}{%
	...
	\mysection{Charaktere}
		...
		\noindent
		Die Spieler verkörpern solarbetriebene \keyword{Androiden}. Im Stromsparmodus müssen sie auf eine wichtige Funktion verzichten: das Sprachmodul. Sie können nur Ein-Wort-Sätze oder frühkindliches Geplärre wie \say{Wähhhh!} von sich geben.
