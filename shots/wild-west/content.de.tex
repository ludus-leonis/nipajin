...
\renewcommand{\wildwestVersion}{v1.0.1-wip}
...
\renewcommand{\wildwestCredits}{Text: André \say{Seanchui} Frenzer}
...
\renewcommand{\wildwestText}{%
	...
	\mysection{Charaktere}
		...
		\noindent
		In diesem Szenario verkörpern die Spieler die befreundeten Goldgräber und Cowboys Jack, Jake, Jay und Joe (\HD8). Als Ausrüstung erhalten sie je ein Pferd sowie Revolver und ausreichend Munition (2 Wunden). Außerdem führen sie das Nötigste für einen kurzen Ritt durch die Wüste -- Hüte, Tücher, einen Wasserschlauch -- bei sich. Sie erhalten keine besonderen Vor- oder Nachteile, aber Aktionen, die zu typischen Revolverhelden passen, sind um +1 erleichtert.
	...
	\mysection{Ablauf}
		...
		\noindent
		Gleich zwei Parteien haben es auf die Bank und damit auf das Ersparte der Charaktere abgesehen -- eine Bande räuberischer Indianer sowie ein verrückter Wissenschaftler, Ian McDermid, der mithilfe einer dampfmechanischen Spinne das Gebäude zu knacken gedenkt.
		...
		Es wird in Runden von einer Minute vorgegangen. Jeder Charakter kann sich \zB\ an einen Indianer heranschleichen (\TN3), um diesen ohne Gegenwehr anzugreifen. Alternativ können Goldschürfer versuchen, einen Hinterhalt zu legen (langfristige Aktion, \TN12), um W4+1 Indianer in eine Falle laufen zu lassen und auszuschalten. Wer sich versucht, hinter Fässern zu verschanzen (\TN3, +1 auf Verteidigung) oder direkt zur Bank läuft (2 Runden), dem stellen sich drei Indianer gleichzeitig in den Weg.

		\nsc{Indianer}{4}{6}{4}, Schießen vom Pferd -1, ergibt sich in aussichtloser Situation
