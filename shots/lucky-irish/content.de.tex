...
\renewcommand{\luckyirishVersion}{v1.0}

\newcommand{\scenarioVersionTaverne}{v0.2}
...
\renewcommand{\luckyirishTranslation}{\tiny Text: Dennis Filipiak, Lektorat: Markus Leupold-Löwenthal}
\renewcommand{\luckyirishDisclaimer}{(Logos und Marken ausgenommen.)}
...
\renewcommand{\luckyirishSummary}{%
