...
\renewcommand{\archaeaSummary}{%
	...
	To play the following scenario, you will need the NIP'AJIN rules booklet. It is available for free at~\ldots
}
...
\renewcommand{\archaeaText}{%
	{\itshape
		...
		In the Placebo sub-sector, months of jumping from Earth, the ring-shaped mobile space station Archaea-12 and its team of 20 scientists float above newly discovered Heures-3. This planet, the first discovered with a flora and fauna, resembles Earth 100 million years ago. Even reptiles were found living down there! Though prohibited by strong quarantine rules, scientists bring samples of plants, lizards and reptile eggs on board to study them.
	...
	\mysection{Development}
		...
		\keyword{Panic phases} are resolved like conflicts, while the creature attacks the PCs. Moving around the station requires an \AD~and Agility\TN4. A success allows to move two spaces, a failure only one. Each station as well as each corridor in between is counted as a space.
