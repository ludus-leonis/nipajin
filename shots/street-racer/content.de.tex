...
\renewcommand{\streetracerVersion}{v1.0}
...
\renewcommand{\streetracerTranslation}{\tiny Text: André Frenzer, Lektorat: Onno Tasler, Markus Leupold-Löwenthal}
\renewcommand{\streetracerDisclaimer}{(Logos und Marken ausgenommen.)}
...
\renewcommand{\streetracerSummary}{%
