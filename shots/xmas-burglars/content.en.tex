...
\renewcommand{\xmasText}{%
	...
	\mysection{Characters}
		...
		\noindent
		In this scenario the charakters are kids aged 1d4+8:
	...
	\mysection{Setting rules}
		...
		\noindent
		At the start of play, each player gets two candies. If a player waves around with his hands and cries \say{Whaaaahaa}, he may spend one candy and reroll one of his dice. Unused candies may be eaten after the game.

	\mysection{All's well that ends well?}

		\noindent
		The kids win if the burglars loose more than half of their \HD-values in total -- no matter what burglar lost how much exactly. The kids loose if they all are covercome or the burglars flee with 16 valuables.
}
