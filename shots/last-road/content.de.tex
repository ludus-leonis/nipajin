...
\renewcommand{\lastroadVersion}{v1.0}
...
\renewcommand{\lastroadTranslation}{\tiny Text: André Frenzer; Lektorat: Onno Tasler, Markus Leupold-Löwenthal}
\renewcommand{\lastroadDisclaimer}{(Logos und Marken ausgenommen.)}
