...
\renewcommand{\nipajinSummary}{%
	...
	\nipajin\ ha sido diseñado para jugar campañas cortas o one-shots, se pronuncia \say{nip-a-dshin} y es un acrónimo de una frase alemana que se traduce como \say{Nadie es perfecto, pero todo el mundo puede contribuir}. Permite compartir la escena entre los personajes sin forzarlos con un conjunto de reglas estricto.
}
