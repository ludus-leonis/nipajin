...
\renewcommand{\versionRules}{v1.5.1-pl}
...
\renewcommand{\translation}{Tłumaczenie: Szymon \say{Noobirus} Piecha}


% --- headlines --------------------------------------------------------

\renewcommand{\disclaimer}{(Oprócz logo i~nazwy marek.)}
\renewcommand{\headlinePlayer}{Zasady dla graczy}
\renewcommand{\headlineGM}{Zasady dla prowadzących}
\renewcommand{\headlineEffects}{Efekty}
