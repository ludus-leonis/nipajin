...
\renewcommand{\nipajinTextPlayer}{%
	...
	\mysection[labelConflict]{Konflikte}
		...
		Für einen erfolgreichen Angriff muss der \AD\ des Angreifers ein höheres Ergebnis erzielen als der \RD\ des Gegners, eine gewürfelte Eins ist immer ein Fehlschlag. Bei einem erfolgreichen Angriff erleidet der Reagierende eine \keyword{Wunde} und reduziert den \HD\ um 1. Gewaltlose Aktionen helfen ebenfalls, den Widerstand der Gegner zu brechen: Sie verursachen \keyword{Traumata}, die durch Spielsteine o.\,Ä. symbolisiert werden.
