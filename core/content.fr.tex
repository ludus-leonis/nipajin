...
\renewcommand{\nipajinSummary}{%
	...
	\nipajin\ Conçu en vue d'aventures one-shot et de campagnes courtes, ce jeu se prononce \say{nip-atschin} - acronyme de \say{personne n'est parfait, amais chacun peut contribuer}. Il vise à permettre aux personnages de se partager le premier rôle, sans les enfermer dans un carcan de règles.
}
